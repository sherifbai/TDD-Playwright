...
test.describe('[administration] [functional] Domains are added, edited and deleted through the list', () => {
  ...
  test('A saved domain is confirmed, listed and read back with the values entered', async ({ page }) => {
    const mdp = new AdminPageFactory(page).getMultiDomainsPage();
  ...
  test('An edited domain keeps its place and comes back with the new values', async ({ page }) => {
    const mdp = new AdminPageFactory(page).getMultiDomainsPage();
  ...
  test('A deleted domain is gone from the list after a reload', async ({ page }) => {
    const mdp = new AdminPageFactory(page).getMultiDomainsPage();
